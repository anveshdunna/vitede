...
const CardFront = (props) => {
  ...
  const logo = physical ? "black" : "#B6BAC3";
  const logoShimmer = physical ? "#E5E9ED" : "white";
  ...
  return (
    <div className="relative z-[2] overflow-clip rounded-2xl outline outline-1 -outline-offset-1 outline-gray-900/20">
      ...
      >
        ...
        {/* Shimmer 1 */}
        <div
          className={`absolute -left-10 -top-40 h-[40rem] w-10 bg-white ${shimmerColor} shine blur-lg`}
        ></div>
        ...
        <div className="absolute">
          ...
          >
            <defs>
              ...
              >
                <stop offset="0%" stopColor={logo} />
                <stop offset="38%" stopColor={logo} />
                <stop offset="40%" stopColor={logoShimmer} />
                <stop offset="80%" stopColor={logoShimmer} />
                <stop offset="82%" stopColor={logo} />
        ...
        {physical && (
          <div className="absolute">
            ...
            >
              <path
                fill="#4D5668"
                d="M72.58 32.5C72.3 41.1 65.12 48 56.29 48c-8.82 0-16.01-6.9-16.28-15.5L40 33c0 8.83 7.3 16 16.3 16 8.99 0 16.29-7.17 16.29-16l-.01-.5Z"
              />
              <path
                fill="#4D5668"
                d="m68.16 24.64.33.22.25.22.1.22v.22l-.17.5-.18-.16-.33-.22-.22-.03h-1.1l-.45.22-.68.42-1.8 1.33-1.07.86L59 31.55l-1.02.03-4.25-.37-2.77-.17-.3.07-2.58 1.41-.52-.25-.18-.1.03-.17.15-.2 3.1-1.69.3-.07 2.77.17 4.25.37 1.02-.03 3.85-3.11 1.08-.86 1.8-1.33.67-.42.45-.22h1.1l.22.03ZM53.07 35.94l-2.42 2.4-3.85-.48-.78.03-2 1.3-.1.37.64.28 1.46-.95.78-.02 3.85.46 3.1-3.07-.68-.32ZM82.67 20.78c-.2.96-1.06 1.67-2.31 1.67a2.16 2.16 0 0 1-2.17-1.71c-.04.16-.05.33-.05.5 0 1.23.92 2.21 2.22 2.21 1.47 0 2.4-.98 2.35-2.2 0-.17-.02-.32-.04-.47ZM82.28 45.67h-3.67v1h3.67v-1ZM89.2 28.56h-3.12v1h3.12v-1ZM89.2 39.36v1c0 2.36.38 4.12 1.43 5.18.87.98 2.25 1.52 3.97 1.52 1.4 0 2.55-.2 3.25-.49l-.06-.97c-.7.28-1.83.46-3.19.46-1.72 0-3.1-.54-3.97-1.52-1.05-1.06-1.43-2.82-1.43-5.18ZM92.8 29.56h5.28v-1H92.8v1ZM106.28 20.78c-.2.96-1.05 1.67-2.3 1.67a2.16 2.16 0 0 1-2.18-1.71c-.03.16-.05.33-.05.5 0 1.23.92 2.21 2.22 2.21 1.48 0 2.4-.98 2.35-2.2 0-.17-.01-.32-.04-.47ZM102.22 45.67v1h3.68v-1h-3.68ZM112 45.67v1h3.67v-1H112ZM125.92 20.78c-.2.96-1.05 1.67-2.3 1.67a2.16 2.16 0 0 1-2.18-1.71c-.03.16-.05.33-.05.5 0 1.23.92 2.21 2.22 2.21 1.48 0 2.4-.98 2.35-2.2 0-.17-.01-.32-.04-.47ZM125.54 45.67h-3.68v1h3.68v-1ZM132.46 28.56h-3.12v1h3.12v-1ZM132.46 39.36v1c0 2.36.38 4.12 1.43 5.18.87.98 2.25 1.52 3.97 1.52 1.4 0 2.55-.2 3.25-.49l-.06-.97c-.7.28-1.83.46-3.19.46-1.72 0-3.1-.54-3.97-1.52-1.05-1.06-1.43-2.82-1.43-5.18ZM136.06 29.56h5.27v-1h-5.27v1ZM147.32 37.42c-.04-.32-.06-.66-.06-1h14.22c.03-.28.09-.7.1-1.2a11 11 0 0 1-.1 2.2h-14.16ZM160.2 44.95l.23.9a16.8 16.8 0 0 1-6.73 1.24c-6.22 0-9.94-4.03-9.94-10.02v-.5c.2 5.71 3.9 9.52 9.94 9.52 3.05 0 5.18-.6 6.5-1.14ZM158.05 33.82c.05-2.31-.95-5.87-5.1-5.87-3.72 0-5.34 3.36-5.64 5.87h.18c.57-2.32 2.22-4.87 5.46-4.87 3.59 0 4.82 2.66 5.06 4.87h.04Z"
              />
            </svg>
          </div>
        )}
        ...
        {!physical && (
          <div className="absolute">
            ...
            >
              <path
                fill="#363E4F"
                d="M72.58 31.5V31c0-8.83-7.29-16-16.29-16S40 22.17 40 31v.5c.28-8.6 7.47-15.5 16.3-15.5 8.82 0 16.01 6.9 16.28 15.5ZM48.07 31.52l-.52.28-.15.2-.03.17.18.1 5.52 2.67.67-.68-5.67-2.74Z"
              />
              <path
                fill="#363E4F"
                d="m44.56 38.84 3.41 1.53h.75l1.95-.85 5.27-2.8 6.28-5.25 4.42-3.88L68 26.24l.38-.64.22-.42.06-.16.07.06.1.22v.22l-.23.66-.22.42-.38.64-1.37 1.35-4.42 3.88-6.28 5.25-5.27 2.8-1.95.85h-.75l-4.05-1.81.1-.37.54-.35ZM82.67 19.78c.03-.17.05-.35.04-.53 0-1.28-.88-2.26-2.28-2.26-1.35 0-2.3.98-2.3 2.26 0 .17.02.33.06.49a2.2 2.2 0 0 1 2.24-1.75c1.23 0 2.05.75 2.24 1.79ZM78.61 25.82v-1h3.67v1h-3.67ZM92.8 19.12v1l-3.6.93v-1l3.6-.93ZM89.2 24.82h-3.12v1h3.12v-1ZM97.79 44.6l.06-.03-.17-2.7a8.3 8.3 0 0 1-2.13.25c-2.05 0-2.75-1.4-2.75-3.86v1c0 2.46.7 3.86 2.75 3.86a8.3 8.3 0 0 0 2.13-.25l.1 1.73ZM98.08 25.82v-1H92.8v1h5.28ZM101.8 19.74a2.2 2.2 0 0 1 2.25-1.75c1.2 0 2.04.75 2.23 1.79.04-.17.05-.35.04-.53 0-1.28-.9-2.26-2.27-2.26-1.35 0-2.3.98-2.3 2.26 0 .17.02.33.05.49ZM102.22 24.82v1h3.68v-1h-3.68ZM115.67 15.54H112v1h3.67v-1ZM125.92 19.78c.04-.17.05-.35.04-.53 0-1.28-.9-2.26-2.27-2.26-1.35 0-2.3.98-2.3 2.26 0 .17.02.33.05.49a2.2 2.2 0 0 1 2.25-1.75c1.2 0 2.04.75 2.23 1.79ZM121.86 25.82v-1h3.68v1h-3.68ZM136.06 19.12v1l-3.6.93v-1l3.6-.93ZM132.46 24.82h-3.12v1h3.12v-1ZM141.05 44.6l.06-.03-.18-2.7a8.3 8.3 0 0 1-2.12.25c-2.05 0-2.75-1.4-2.75-3.86v1c0 2.46.7 3.86 2.75 3.86a8.3 8.3 0 0 0 2.12-.25l.12 1.73ZM141.33 25.82v-1h-5.27v1h5.27ZM147.32 36.42c.47 4.16 3.45 5.9 6.88 5.9 2.63 0 4.23-.45 5.6-1.04l.63 2.58-.22.1-.4-1.68a13.27 13.27 0 0 1-5.6 1.03c-3.7 0-6.88-2-6.95-6.9h.06ZM143.77 35.57l-.01-.5c0-5.98 3.6-10.7 9.5-10.7 6.6 0 8.34 5.7 8.34 9.35l-.01.5c-.16-3.66-2.04-8.85-8.34-8.85-5.73 0-9.29 4.45-9.48 10.2Z"
              />
              <path
                fill="#363E4F"
                d="M158 32.82H147.5c-.09.34-.15.67-.18 1h10.74c0-.32 0-.66-.04-1Z"
              />
            </svg>
          </div>
        )}
